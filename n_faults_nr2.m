function [data,id_faults_valid_n,id_faults_critical] = n_faults_nr2(k,A,B,D,S,id_faults_valid,faults)
    data = [];
    ...
    for i=1:Ns
        ...
        %Roles_comb_valid = valid_rolescomb(Roles_list,ACz_new,DCz_new);
        %Rolecombs{i} = Roles_comb_valid;
    end
